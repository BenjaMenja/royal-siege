execute if entity @s[tag=redmushroom] run summon minecraft:area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{Name:"minecraft:brown_mushroom_block",Properties:{up:"true",down:"false",north:"false",south:"false",east:"false",west:"false"}}},ReapplicationDelay:10,Radius:4f,RadiusPerTick:0f,RadiusOnUse:0.3f,Duration:160,potion_contents:{custom_effects:[{id:"minecraft:poison",amplifier:1,duration:20,show_particles:0b}]},Tags:["redmushroom","mushroom"]}
