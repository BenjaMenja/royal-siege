loot give @s[team=Blue,scores={Kit=6}] loot commands:main_abilities/lightning_staff
...
execute if score #gamemode settings matches 0 if score #classicMap settings matches 2 run tp @s[team=Blue] 19 64 -2041 0 0