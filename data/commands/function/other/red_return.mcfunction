loot give @s[team=Red,scores={Kit=6}] loot commands:main_abilities/lightning_staff
...
execute if score #gamemode settings matches 0 if score #classicMap settings matches 2 run tp @s[team=Red] 19 64 -1901 180 0