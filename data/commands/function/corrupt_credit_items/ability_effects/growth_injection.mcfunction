...
attribute @e[sort=nearest,distance=..3,tag=growthinjected,limit=1] scale modifier add 17-1-20-0-0 0.2 add_multiplied_base

attribute @e[sort=nearest,distance=..3,tag=growthinjected,limit=1] attack_damage modifier add 2-1-20-0-0 0.2 add_multiplied_base
