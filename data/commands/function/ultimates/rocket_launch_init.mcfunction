...
summon minecraft:item_frame ~ ~ ~ {Facing:1b,Invulnerable:1b,Invisible:1b,Fixed:1b,Tags:["rocketPad"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_model_data":{floats:[181]}}}}
