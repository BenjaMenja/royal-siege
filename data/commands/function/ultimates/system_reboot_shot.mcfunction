execute at @s[team=Red] anchored eyes run summon minecraft:item ^ ^ ^1 {Health:1000,PickupDelay:32767,Tags:["systemRebootRed","systemReboot","redProj","ultimateProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:system_reboot"}}}

execute at @s[team=Blue] anchored eyes run summon minecraft:item ^ ^ ^1 {Health:1000,PickupDelay:32767,Tags:["systemRebootBlue","systemReboot","blueProj","ultimateProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:system_reboot"}}}
...
clear @s carrot[custom_data~{systemreboot:1b}] 1