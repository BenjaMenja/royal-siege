scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 5

scoreboard players set @s[scores={ultCheck=0}] ultCheck 5

tellraw @s[scores={ultCheck=5}] {"text":"You chose to use Chaos Bow!","color":"aqua"}
