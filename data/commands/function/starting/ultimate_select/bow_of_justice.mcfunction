scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 15

scoreboard players set @s[scores={ultCheck=0}] ultCheck 15

tellraw @s[scores={ultCheck=15}] {"text":"You chose to use Bow of Justice!","color":"aqua"}
