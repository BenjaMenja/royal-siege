scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 30

scoreboard players set @s[scores={ultCheck=0}] ultCheck 30

tellraw @s[scores={ultCheck=30}] {"text":"You chose to use Pop Rocks!","color":"aqua"}
