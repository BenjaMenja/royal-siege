scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 25

scoreboard players set @s[scores={ultCheck=0}] ultCheck 25

tellraw @s[scores={ultCheck=25}] {"text":"You chose to use Busted!","color":"aqua"}
