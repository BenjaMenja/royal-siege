scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 28

scoreboard players set @s[scores={ultCheck=0}] ultCheck 28

tellraw @s[scores={ultCheck=28}] {"text":"You chose to use Smart Drone!","color":"aqua"}
