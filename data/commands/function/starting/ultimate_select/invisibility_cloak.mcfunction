scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 11

scoreboard players set @s[scores={ultCheck=0}] ultCheck 11

tellraw @s[scores={ultCheck=11}] {"text":"You chose to use Invisbility Cloak!","color":"aqua"}
