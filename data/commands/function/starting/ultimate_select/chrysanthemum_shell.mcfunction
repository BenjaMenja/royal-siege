scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 29

scoreboard players set @s[scores={ultCheck=0}] ultCheck 29

tellraw @s[scores={ultCheck=29}] {"text":"You chose to use Chrysanthemum Shell!","color":"aqua"}
