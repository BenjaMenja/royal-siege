scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 4

scoreboard players set @s[scores={ultCheck=0}] ultCheck 4

tellraw @s[scores={ultCheck=4}] {"text":"You chose to use Lifeforce!","color":"aqua"}
