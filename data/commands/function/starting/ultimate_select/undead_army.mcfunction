scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 33

scoreboard players set @s[scores={ultCheck=0}] ultCheck 33

tellraw @s[scores={ultCheck=33}] {"text":"You chose to use Undead Army!","color":"aqua"}
