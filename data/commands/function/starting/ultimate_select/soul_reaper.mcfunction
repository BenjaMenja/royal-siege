scoreboard players set @s[predicate=commands:location/practice_range/in_practice_range] ultCheck 34

scoreboard players set @s[scores={ultCheck=0}] ultCheck 34

tellraw @s[scores={ultCheck=34}] {"text":"You chose to use Soul Reaper!","color":"aqua"}
