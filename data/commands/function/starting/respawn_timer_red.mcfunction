...
execute if data storage royalsiege:settings {Gamemode:0} if data storage royalsiege:settings {Maps:{Classic:{value:0}}} run teleport @s[scores={Respawn=200..}] 22 60 -198

execute if data storage royalsiege:settings {Gamemode:0} if data storage royalsiege:settings {Maps:{Classic:{value:1}}} run teleport @s[scores={Respawn=200..}] 139 60 -1004
