...
execute if score #gamemode settings matches 0 if score #classicMap settings matches 2 run teleport @s[scores={Respawn=200..}] 19 64 -1901

execute if score #gamemode settings matches 1 if score #tdmMap settings matches 0 run teleport @s[scores={Respawn=200..},predicate=!commands:in_tdm_gates] 1086 53 -61

execute if score #gamemode settings matches 1 if score #tdmMap settings matches 1 run teleport @s[scores={Respawn=200..},predicate=!commands:in_tdm_gates] 2046 106 -33
