...
title @s[tag=!hasDebrisCannon,tag=!hasGravityCanceler,tag=!upgraded] actionbar [{"text":"Fine Tuning: ","color":"green"},{"score":{"name":"*","objective":"wrenchDis"},"color":"aqua"},{"text":"   Asteroid: ","color":"green"},{"score":{"name":"*","objective":"asteroidDis"},"color":"aqua"}]

title @s[tag=!hasDebrisCannon,tag=!hasGravityCanceler,tag=!upgraded] actionbar [{"text":"Fine Tuning: ","color":"green"},{"score":{"name":"*","objective":"wrenchDis"},"color":"aqua"},{"text":"   Asteroid: ","color":"green"},{"score":{"name":"*","objective":"asteroidDis"},"color":"aqua"}]

title @s[tag=hasDebrisCannon,tag=!hasGravityCanceler,tag=!upgraded] actionbar [{"text":"Fine Tuning: ","color":"green"},{"score":{"name":"*","objective":"wrenchDis"},"color":"aqua"},{"text":"   Asteroid: ","color":"green"},{"score":{"name":"*","objective":"asteroidDis"},"color":"aqua"},{"text":"   Debris Cannon: ","color":"green"},{"score":{"name":"*","objective":"debrisDis"},"color":"aqua"}]

title @s[tag=!hasDebrisCannon,tag=hasGravityCanceler,tag=!upgraded] actionbar [{"text":"Fine Tuning: ","color":"green"},{"score":{"name":"*","objective":"wrenchDis"},"color":"aqua"},{"text":"   Asteroid: ","color":"green"},{"score":{"name":"*","objective":"asteroidDis"},"color":"aqua"},{"text":"   Gravity Canceler: ","color":"green"},{"score":{"name":"*","objective":"gravityDis"},"color":"aqua"}]

title @s[tag=!hasDebrisCannon,tag=!hasGravityCanceler,tag=upgraded] actionbar [{"text":"Fine Tuning: ","color":"green"},{"score":{"name":"*","objective":"wrenchDis"},"color":"aqua"},{"text":"   Asteroid: ","color":"green"},{"score":{"name":"*","objective":"asteroidDis"},"color":"aqua"},{"text":"   Explosive Landing: ","color":"green"},{"score":{"name":"*","objective":"astroPassDis"},"color":"aqua"}]
