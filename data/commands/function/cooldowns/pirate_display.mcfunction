...
title @s[predicate=!commands:inventory/chain_hook,predicate=!commands:inventory/coin_gun] actionbar [{"text":"Blunderbuss: ","color":"green"},{"score":{"name":"*","objective":"blunderDis"},"color":"aqua"},{"text":"   Fake Money: ","color":"green"},{"score":{"name":"*","objective":"fakeDis"},"color":"aqua"}]

title @s[predicate=!commands:inventory/chain_hook,predicate=commands:inventory/coin_gun] actionbar [{"text":"Blunderbuss: ","color":"green"},{"score":{"name":"*","objective":"blunderDis"},"color":"aqua"},{"text":"   Fake Money: ","color":"green"},{"score":{"name":"*","objective":"fakeDis"},"color":"aqua"},{"text":"   Coin Gun: ","color":"green"},{"score":{"name":"*","objective":"coinGunDis"},"color":"aqua"}]
