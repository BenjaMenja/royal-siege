...
execute if score #rng RNG matches 1 on attacker run tellraw @a [{"selector":"@a[advancements={commands:custom_deaths/anchor_death=true}]"},{"text":" was thrown overboard by ","color":"white"},{"selector":"@s"}]
