...
execute as @e[type=wither_skeleton,tag=dummy,tag=!found] run data modify entity @s attributes[{id:"minecraft:generic.max_health"}].base set from storage royalsiege:dummy_hp HP
