summon snowball ~ ~ ~ {Tags:["bangsnapblue","init","snowball","blueProj"],Passengers:[{id:"marker",Tags:["bangsnapblue","blueProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:bang_snap"}}}
