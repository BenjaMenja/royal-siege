summon snowball ~ ~ ~ {Tags:["cinderbombblue","init","snowball","blueProj"],Passengers:[{id:"marker",Tags:["cinderbombblue","blueProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:cinder_bomb"}}}
