summon snowball ~ ~ ~ {Tags:["cinderbombblue","init","snowball","blueProj"],Passengers:[{id:"marker",Tags:["cinderbombblue","blueProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:custom_model_data":{floats:[192]}}}}
