summon snowball ~ ~ ~ {Tags:["shurikenblue","init","snowball","blueProj"],Passengers:[{id:"marker",Tags:["shurikenblue","blueProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:custom_model_data":{floats:[95]}}}}
