summon snowball ~ ~ ~ {Tags:["shurikenblue","init","snowball","blueProj"],Passengers:[{id:"marker",Tags:["shurikenblue","blueProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:shuriken"}}}
