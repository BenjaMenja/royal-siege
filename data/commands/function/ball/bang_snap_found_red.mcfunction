summon snowball ~ ~ ~ {Tags:["bangsnapred","init","snowball","redProj"],Passengers:[{id:"marker",Tags:["bangsnapred","redProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:bang_snap"}}}
