summon snowball ~ ~ ~ {Tags:["necroboneblue","init","snowball","blueProj"],Passengers:[{id:"marker",Tags:["necroboneblue","blueProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:custom_model_data":{floats:[211]}}}}
