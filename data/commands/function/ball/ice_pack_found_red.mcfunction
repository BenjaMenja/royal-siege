summon snowball ~ ~ ~ {Tags:["icepackred","init","snowball","redProj"],Passengers:[{id:"marker",Tags:["icepackred","redProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:ice_pack"}}}
