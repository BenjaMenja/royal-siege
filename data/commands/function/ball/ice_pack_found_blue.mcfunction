summon snowball ~ ~ ~ {Tags:["icepackblue","init","snowball","redProj"],Passengers:[{id:"marker",Tags:["icepackblue","redProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:custom_model_data":{floats:[200]}}}}
