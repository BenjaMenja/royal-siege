summon snowball ~ ~ ~ {Tags:["icepackblue","init","snowball","redProj"],Passengers:[{id:"marker",Tags:["icepackblue","redProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:ice_pack"}}}
