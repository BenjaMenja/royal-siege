summon snowball ~ ~ ~ {Tags:["lightningspellred","init","snowball","redProj"],Passengers:[{id:"marker",Tags:["lightningspellred","redProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:custom_model_data":{floats:[48]}}}}
