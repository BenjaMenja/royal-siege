summon snowball ~ ~ ~ {Tags:["necrobonered","init","snowball","redProj"],Passengers:[{id:"marker",Tags:["necrobonered","redProj"]}],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:necro_bone"}}}
