...
execute if entity @s[tag=HSRed] if entity @a[limit=1,team=Red,tag=!HSfound] run function commands:passives/angel_passive
...
execute if entity @s[tag=HSBlue] if entity @a[limit=1,team=Blue,tag=!HSfound] run function commands:passives/angel_passive

#Apply Healing

execute if entity @s[tag=HSRed] as @a[team=Red] if score @s Health = #redHS HSValue run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[team=Red,tag=healstreak]"}

execute if entity @s[tag=HSBlue] as @a[team=Blue] if score @s Health = #redHS HSValue run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[team=Blue,tag=healstreak]"}
