tag @s add payraise
tag @s[team=Red] add payraisered
tag @s[team=Blue] add payraiseblue
scoreboard players set #hit ray.payRaise 0
scoreboard players set #distance ray.payRaise 0
function commands:raycasts/pay_raise_ray
...
tag @s remove payraisered
tag @s remove payraiseblue