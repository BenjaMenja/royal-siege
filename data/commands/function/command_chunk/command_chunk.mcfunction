...
give @a[team=Red,scores={Kit=3,turretTimer=..0}] minecraft:skeleton_spawn_egg[item_model="royalsiege:turret",can_place_on={blocks:"#commands:can_place_on"},tooltip_display={hidden_components:["minecraft:can_place_on"]},custom_name={"color":"#B8481F","italic":false,"text":"Turret"},lore=[{"color":"yellow","italic":false,"text":"Placeable"},{"text": " "}],custom_data={turret:1b},entity_data={id:"minecraft:skeleton",Silent:1b,Team:"Red",Health:25f,Tags:["turret"],equipment:{mainhand:{id:"minecraft:bow",count:1,components:{"minecraft:enchantments":{"minecraft:power":4}}},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":16711680}},head:{id:"minecraft:dispenser",count:1}},drop_chances:{mainhand:0.0,chest:0.0,head:0.0},active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:200000}],attributes:[{id:"minecraft:knockback_resistance",base:1.0},{id:"minecraft:movement_speed",base:-1.0}]}] 1

give @a[team=Blue,scores={Kit=3,turretTimer=..0}] minecraft:skeleton_spawn_egg[item_model="royalsiege:turret",can_place_on={blocks:"#commands:can_place_on"},tooltip_display={hidden_components:["minecraft:can_place_on"]},custom_name={"color":"#B8481F","italic":false,"text":"Turret"},lore=[{"color":"yellow","italic":false,"text":"Placeable"},{"text": " "}],custom_data={turret:1b},entity_data={id:"minecraft:skeleton",Silent:1b,Team:"Blue",Health:25f,Tags:["turret"],equipment:{mainhand:{id:"minecraft:bow",count:1,components:{"minecraft:enchantments":{"minecraft:power":4}}},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":255}},head:{id:"minecraft:dispenser",count:1}},drop_chances:{mainhand:0.0,chest:0.0,head:0.0},active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:200000}],attributes:[{id:"minecraft:knockback_resistance",base:1.0},{id:"minecraft:movement_speed",base:-1.0}]}] 1
...
execute as @a[scores={Kit=9}] if items entity @s weapon.mainhand trident[custom_data~{poseidontrident:1b}] run scoreboard players set @s tridentSlot 0

execute as @a[scores={Kit=9}] if items entity @s weapon.offhand trident[custom_data~{poseidontrident:1b}] run scoreboard players set @s tridentSlot 1
...
execute as @a[scores={pBowTimer=100}] run function commands:replace/punch_bow_ready_check {custom_data:{punchbowitem:1b}}
...
execute as @a[team=Red,tag=HSinit,tag=!healstreak] at @s run summon minecraft:item ~1 ~1.5 ~ {NoGravity:1b,Age:-32768,Health:1000,PickupDelay:32767,Tags:["angelpassive","HSRed"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:item_model":"royalsiege:pixie","minecraft:custom_data":{angelpassive:1b}}}}

execute as @a[team=Blue,tag=HSinit,tag=!healstreak] at @s run summon minecraft:item ~1 ~1.5 ~ {NoGravity:1b,Age:-32768,Health:1000,PickupDelay:32767,Tags:["angelpassive","HSBlue"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:item_model":"royalsiege:pixie","minecraft:custom_data":{angelpassive:1b}}}}
...
execute as @a[scores={Kit=15,sparklerTimer=1}] run function commands:replace/sparkler_ready_check {custom_data:{sparklerunlit:1b}}
