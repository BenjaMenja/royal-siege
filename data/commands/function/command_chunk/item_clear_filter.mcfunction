...
scoreboard players set @e[type=item,tag=ivNeedle] ItemKill 2

scoreboard players set @e[type=item,tag=sparkingStaffProjectile] ItemKill 2

scoreboard players set @e[type=item,tag=arcaneSphereProj] ItemKill 2
