summon minecraft:item_frame ~ ~ ~ {Tags:["oven"],Invulnerable:1b,Invisible:1b,Fixed:1b,Facing:3b,Item:{id:"minecraft:stone_bricks",count:1,components:{"minecraft:item_model":"royalsiege:oven_closed"}}}
