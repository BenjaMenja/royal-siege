execute at @s[team=Red] anchored eyes run summon minecraft:item ^ ^ ^1 {PickupDelay:32767,Invulnerable:1b,Tags:["sparkleritem","sparklerred","redProj"],Item:{id:"minecraft:yellow_dye",count:1,components:{"minecraft:item_model":"royalsiege:sparkler_projectile"}}}

execute at @s[team=Red] anchored eyes run summon minecraft:item ^0.05 ^ ^1 {PickupDelay:32767,Invulnerable:1b,Tags:["sparkleritem","sparklerred","redProj"],Item:{id:"minecraft:yellow_dye",count:1,components:{"minecraft:item_model":"royalsiege:sparkler_projectile"}}}

execute at @s[team=Red] anchored eyes run summon minecraft:item ^-0.05 ^ ^1 {PickupDelay:32767,Invulnerable:1b,Tags:["sparkleritem","sparklerred","redProj"],Item:{id:"minecraft:yellow_dye",count:1,components:{"minecraft:item_model":"royalsiege:sparkler_projectile"}}}

execute at @s[team=Blue] anchored eyes run summon minecraft:item ^ ^ ^1 {PickupDelay:32767,Invulnerable:1b,Tags:["sparkleritem","sparklerblue","blueProj"],Item:{id:"minecraft:yellow_dye",count:1,components:{"minecraft:item_model":"royalsiege:sparkler_projectile"}}}

execute at @s[team=Blue] anchored eyes run summon minecraft:item ^0.05 ^ ^1 {PickupDelay:32767,Invulnerable:1b,Tags:["sparkleritem","sparklerblue","blueProj"],Item:{id:"minecraft:yellow_dye",count:1,components:{"minecraft:item_model":"royalsiege:sparkler_projectile"}}}
