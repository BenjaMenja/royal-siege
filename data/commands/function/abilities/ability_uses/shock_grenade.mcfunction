execute at @s[team=Red] anchored eyes run summon minecraft:item ^ ^ ^1 {PickupDelay:32767,Tags:["shockGrenade","shockGrenadeRed","redProj"],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:shock_grenade"}}}

execute at @s[team=Blue] anchored eyes run summon minecraft:item ^ ^ ^1 {PickupDelay:32767,Tags:["shockGrenade","shockGrenadeBlue","blueProj"],Item:{id:"minecraft:snowball",count:1,components:{"minecraft:item_model":"royalsiege:shock_grenade"}}}
