execute at @s[team=Red] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,Tags:["coinBulletRed","coinBullet","redProj"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_model_data":{floats:[148]}}}}

execute at @s[team=Red] anchored eyes run summon item ^0.05 ^ ^1 {Health:1000,PickupDelay:32767,Tags:["coinBulletRed","coinBullet","redProj"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_model_data":{floats:[148]}}}}

execute at @s[team=Red] anchored eyes run summon item ^-0.05 ^ ^1 {Health:1000,PickupDelay:32767,Tags:["coinBulletRed","coinBullet","redProj"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_model_data":{floats:[148]}}}}

execute at @s[team=Blue] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,Tags:["coinBulletBlue","coinBullet","blueProj"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_model_data":{floats:[148]}}}}

execute at @s[team=Blue] anchored eyes run summon item ^0.05 ^ ^1 {Health:1000,PickupDelay:32767,Tags:["coinBulletBlue","coinBullet","blueProj"],Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_model_data":{floats:[148]}}}}
