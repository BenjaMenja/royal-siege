...
execute at @s[team=Red] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["defibRed","defib","redProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:defibrillator"}}}

execute at @s[team=Blue] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["defibBlue","defib","blueProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:defibrillator"}}}
