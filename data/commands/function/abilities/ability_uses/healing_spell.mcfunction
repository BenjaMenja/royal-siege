...
execute at @s[team=Red,tag=!wrenched] as @a[team=Red,distance=..10] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[tag=healingspelluser]"}

execute at @s[team=Red,tag=!wrenched] as @a[team=Red,tag=blessed] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[tag=healingspelluser]"}
...
execute at @s[team=Red,tag=wrenched] as @a[team=Red,distance=..10] run function commands:utils/heal/custom_heal {health:8,ult_charge_receiver:"@a[tag=healingspelluser]"}

execute at @s[team=Red,tag=wrenched] as @a[team=Red,tag=blessed] run function commands:utils/heal/custom_heal {health:8,ult_charge_receiver:"@a[tag=healingspelluser]"}
...
execute at @s[team=Blue,tag=!wrenched] as @a[team=Blue,distance=..10] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[tag=healingspelluser]"}

execute at @s[team=Blue,tag=!wrenched] as @a[team=Blue,tag=blessed] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[tag=healingspelluser]"}
...
execute at @s[team=Blue,tag=wrenched] as @a[team=Blue,distance=..10] run function commands:utils/heal/custom_heal {health:8,ult_charge_receiver:"@a[tag=healingspelluser]"}

execute at @s[team=Blue,tag=wrenched] as @a[team=Blue,tag=blessed] run function commands:utils/heal/custom_heal {health:8,ult_charge_receiver:"@a[tag=healingspelluser]"}
