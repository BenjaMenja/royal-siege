...
execute at @s[tag=!charged,team=Red] anchored eyes run summon fireball ^ ^ ^1 {ExplosionPower:3,Tags:["WF","fm","redProj"],CustomName:{"text":"Wizard Fireball"},CustomNameVisible:0b}

execute at @s[tag=charged,team=Red] anchored eyes run summon fireball ^ ^ ^1 {ExplosionPower:5,Tags:["WF","fm","redProj"],CustomName:{"text":"Wizard Fireball"},CustomNameVisible:0b}

execute at @s[tag=!charged,team=Blue] anchored eyes run summon fireball ^ ^ ^1 {ExplosionPower:3,Tags:["WF","fm","blueProj"],CustomName:{"text":"Wizard Fireball"},CustomNameVisible:0b}

execute at @s[tag=charged,team=Blue] anchored eyes run summon fireball ^ ^ ^1 {ExplosionPower:5,Tags:["WF","fm","blueProj"],CustomName:{"text":"Wizard Fireball"},CustomNameVisible:0b}
...
execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] Motion[0] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posX

execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] Motion[1] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posY

execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] Motion[2] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posZ
