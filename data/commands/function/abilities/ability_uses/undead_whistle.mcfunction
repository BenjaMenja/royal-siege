...
execute if entity @s[team=Red] as @e[predicate=!commands:entities/necromancer_cant_target,distance=..25,team=Red] run function commands:abilities/ability_effects/undead_whistle_warp with storage royalsiege:main

execute if entity @s[team=Blue] as @e[predicate=!commands:entities/necromancer_cant_target,distance=..25,team=Blue] run function commands:abilities/ability_effects/undead_whistle_warp with storage royalsiege:main
