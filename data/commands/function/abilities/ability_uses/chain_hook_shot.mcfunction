execute at @s[team=Red] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["hookRed","hook","redProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:chain_hook"}}}

execute at @s[team=Blue] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["hookBlue","hook","blueProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:chain_hook"}}}
