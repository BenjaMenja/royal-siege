...
execute if entity @s[team=Red] if entity @e[type=item,tag=ivRed] as @p[team=Red,tag=ivAttached] at @s run function commands:abilities/ability_cleanup/iv_detach

execute if entity @s[team=Blue] if entity @e[type=item,tag=ivBlue] as @p[team=Blue,tag=ivAttached] at @s run function commands:abilities/ability_cleanup/iv_detach
...
execute at @s[team=Red] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["ivRed","ivNeedle","redProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:iv_drip"}}}

execute at @s[team=Blue] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["ivBlue","ivNeedle","blueProj"],Item:{id:"minecraft:carrot",count:1,components:{"minecraft:item_model":"royalsiege:iv_drip"}}}
