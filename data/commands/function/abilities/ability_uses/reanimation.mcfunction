...
execute if entity @s[team=Red] as @a[team=Red,tag=notAlive] at @s run function commands:abilities/ability_effects/reanimation_summon

execute if entity @s[team=Blue] as @a[team=Blue,tag=notAlive] at @s run function commands:abilities/ability_effects/reanimation_summon
