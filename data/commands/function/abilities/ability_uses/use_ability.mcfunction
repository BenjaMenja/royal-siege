...
execute if entity @s[scores={absShieldCount=1..,absShieldCD=40..},predicate=commands:holding/absorption_shield] run function commands:abilities/ability_uses/absorption_shield

#Counter

execute if entity @s[predicate=commands:holding/counter] run function commands:abilities/ability_uses/counter
...
execute if entity @s[scores={healSpell=..0},predicate=commands:holding/healing_spell] run function commands:abilities/ability_uses/healing_spell

#Defensive Spell

execute if entity @s[scores={HealerItems=..0},predicate=commands:holding/defensive_spell] run function commands:abilities/ability_uses/defensive_spell

execute if entity @s[scores={defensiveSpell=..0},predicate=commands:holding/defensive_spell] run function commands:abilities/ability_uses/defensive_spell

#Assault Spell

execute if entity @s[scores={HealerItems=..0},predicate=commands:holding/assault_spell] run function commands:abilities/ability_uses/assault_spell

#Rejuvenating Spell

execute at @s[predicate=commands:holding/rejuvenating_spell] run function commands:abilities/ability_uses/rejuvenating_spell

#Shielding Spell

execute at @s[predicate=commands:holding/shielding_spell] run function commands:abilities/ability_uses/shielding_spell

#Vigor Spell

execute at @s[predicate=commands:holding/vigor_spell] run function commands:abilities/ability_uses/vigor_spell
...
execute if entity @s[scores={FireballTimer=..0},predicate=commands:holding/fireball_launcher] at @s run function commands:abilities/ability_uses/wizard_fireball
...
execute if entity @s[scores={ejectTimer=..0},predicate=commands:holding/eject_button,tag=!rooted] at @s run function commands:abilities/ability_uses/eject_button
...
execute if entity @s[tag=blunderShoot] at @s run function commands:abilities/ability_uses/blunderbuss

#Chain Hook

tag @s[predicate=commands:holding/chain_hook] add chain

execute if entity @s[tag=chain,scores={cHookCD=..0}] at @s anchored eyes positioned ^ ^ ^ anchored feet run function commands:abilities/ability_uses/chain_hook_shot
...
execute if entity @s[tag=coinGun] at @s run function commands:abilities/ability_uses/coin_gun

#Flying Dutchman

execute at @s[predicate=commands:holding/flying_dutchman,predicate=!commands:location/battlefields/in_any_throne_room] run function commands:ultimates/flying_dutchman_init

#Blossom

execute if entity @s[scores={blossomTimer=..0},predicate=commands:holding/blossom] at @s run function commands:abilities/ability_uses/blossom
...
execute at @s[scores={squidzookaTimer=..0},predicate=commands:holding/squidzooka] run function commands:abilities/ability_uses/squidzooka
...
tag @s[predicate=commands:holding/gunblade,predicate=!commands:flags/is_sneaking,predicate=commands:inventory/gunblade_ammo] add shoot

execute at @s[tag=shoot] anchored eyes run function commands:abilities/ability_uses/gunblade

#Switch Bullet

tag @s[scores={Kit=10},predicate=commands:holding/gunblade,predicate=commands:flags/is_sneaking] add switching

execute if entity @s[tag=switching] run function commands:abilities/ability_uses/robot_switch

#Iron Wall

execute if entity @s[scores={ironTimer=..0},predicate=commands:holding/iron_wall] run function commands:abilities/ability_uses/iron_wall

#Shock Grenade

execute if entity @s[scores={shockGrenadeTimer=..0},predicate=commands:holding/shock_grenade,predicate=!commands:standing_location/battlefields/no_lightning_area] run function commands:abilities/ability_uses/shock_grenade

#Multi Barrel Attachment

execute if entity @s[predicate=commands:holding/multi_barrel_attachment] run function commands:abilities/ability_uses/multi_barrel_attachment

#Virus Detector

execute if entity @s[predicate=commands:holding/virus_detector,team=Blue] as @r[team=Red,predicate=commands:location/battlefields/in_any_blue_castle] run function commands:abilities/ability_uses/virus_detector

execute if entity @s[predicate=commands:holding/virus_detector,team=Red] as @r[team=Blue,predicate=commands:location/battlefields/in_any_red_castle] run function commands:abilities/ability_uses/virus_detector
...
execute if entity @s[predicate=commands:holding/mysterious_brew] run function commands:corrupt_credit_items/ability_uses/mysterious_brew

#Mystery Basket

execute if entity @s[scores={basketTimer=..0},predicate=commands:holding/mystery_basket] at @s run function commands:abilities/ability_uses/mystery_basket

#Ultimate Charger

execute if entity @s[predicate=commands:holding/ultimate_charger] run function commands:corrupt_credit_items/ability_uses/ultimate_charger

#Castle Chain

execute if entity @s[predicate=commands:holding/castle_chain] run function commands:corrupt_credit_items/ability_uses/castle_chain

#Killer King

execute if entity @s[predicate=commands:holding/killer_king] run function commands:abilities/ability_uses/killer_king
...
execute at @s[scores={scrambleTimer=..0},predicate=commands:holding/scrambled_eggs] run function commands:abilities/ability_uses/scrambled_eggs
...
execute at @s[tag=dRage] run function commands:abilities/ability_uses/dragon_rage
...
execute if entity @s[predicate=commands:holding/corruption] run function commands:abilities/ability_uses/corruption

#Crystal Cannon

execute if entity @s[scores={cCannonTimer=..0},predicate=commands:holding/crystal_cannon] at @s run function commands:abilities/ability_uses/crystal_cannon

#Outrage

execute if entity @s[predicate=commands:holding/outrage] run function commands:abilities/ability_uses/outrage_init
...
execute at @s[tag=cardShooter] run function commands:abilities/ability_uses/playing_cards

#Inspection

execute if entity @s[predicate=commands:holding/inspection] run function commands:abilities/ability_uses/inspection

#Security Guard

execute at @s[predicate=commands:holding/security_guard] run function commands:abilities/ability_uses/security_guard

#Russian Roulette

tag @s[scores={rouletteTimer=..0},predicate=commands:holding/russian_roulette] add rouletteShot

execute at @s[tag=rouletteShot] anchored eyes run function commands:abilities/ability_uses/russian_roulette
...
execute as @a[tag=asteroidShooter] at @s run function commands:abilities/ability_uses/asteroid

#Debris Cannon

tag @s[scores={debrisTimer=..0},predicate=commands:holding/debris_cannon] add debrisShooter

execute at @s[tag=debrisShooter] run function commands:abilities/ability_uses/debris_cannon

#Safety Tether

execute at @s[predicate=commands:holding/safety_tether,tag=tethered] run function commands:abilities/ability_effects/warp_to_tether

execute at @s[predicate=commands:holding/safety_tether,tag=!tethered] run function commands:abilities/ability_uses/create_tether

#Gravity Canceler

execute if entity @s[scores={gravityTimer=..0},predicate=commands:holding/gravity_canceler] run function commands:abilities/ability_uses/gravity_canceler

#Rocket Boosters

execute at @s[predicate=commands:holding/rocket_boosters] run function commands:abilities/ability_uses/rocket_boosters
...
execute if entity @s[scores={sparklerTimer=..0},predicate=commands:holding/sparkler] at @s run function commands:abilities/ability_uses/sparkler

#Blazing Speed

execute if entity @s[scores={blazingSpeedTimer=..0},predicate=commands:holding/blazing_speed] at @s run function commands:abilities/ability_uses/blazing_speed
...
execute at @s[predicate=commands:holding/iv_drip,scores={ivDripTimer=..0}] run function commands:abilities/ability_uses/iv_drip_shot

#Defibrillator

execute at @s[predicate=commands:holding/defibrillator,scores={defibrillatorTimer=..0}] run function commands:abilities/ability_uses/defibrillator_shot
...
execute at @s[predicate=commands:holding/reanimation,scores={reanimationTimer=..0}] run function commands:abilities/ability_uses/reanimation

#Bone Shield

execute at @s[predicate=commands:holding/bone_shield,scores={boneShieldTimer=..0}] run function commands:abilities/ability_uses/bone_shield_init

#Undead Whistle

execute at @s[predicate=commands:holding/undead_whistle,scores={undeadWhistleTimer=..0}] run function commands:abilities/ability_uses/undead_whistle

#Vengeance

execute at @s[predicate=commands:holding/vengeance,scores={vengeanceTimer=..0}] run function commands:abilities/ability_uses/vengeance_init

#Broodmother Spider

execute at @s[predicate=commands:holding/broodmother_spider] run function commands:abilities/ability_uses/broodmother_spider

#Dark Warp

execute at @s[predicate=commands:holding/dark_warp,scores={darkWarpTimer=..0}] run function commands:abilities/ability_uses/dark_warp
...
execute if entity @s[predicate=!commands:flags/is_sneaking,predicate=commands:holding/menu] run tellraw @s [{"color":"green","text":"+"},{"color":"yellow","text":"===================================================="},{"text":"\n"},{"color":"#5AF6F9","text":"Welcome to the Menu!"},{"text":"\n\n"},{"click_event":{"action":"run_command","command":"/trigger textClick set 64"},"color":"gold","hover_event":{"action":"show_text","value":[{"text":"Opens up your character's shop.","color":"green"}]},"text":"[Shops]"},{"text":"                       "},{"click_event":{"action":"run_command","command":"/trigger textClick set 65"},"color":"gold","hover_event":{"action":"show_text","value":[{"text":"Accesses your team's bank.\nYou can view your team's collective amount of Siege Bucks and Corrupt Credits\nas well as deposit and withdraw.","color":"green"}]},"text":"[Bank]"},{"text":"\n\n\n\n"},{"click_event":{"action":"run_command","command":"/trigger textClick set 191"},"color":"gold","hover_event":{"action":"show_text","value":[{"text":"Warps you to your castle's respawn point.","color":"green"},{"text":"\nThis has a 3 second delay, and can be interrupted by taking damage.","color":"green"}]},"text":"[Warp to Castle]"},{"text":"\n\n"},{"color":"green","text":"+"},{"color":"yellow","text":"====================================================\n"}]

#Menu (Crouching opens shop)

execute if entity @s[predicate=commands:flags/is_sneaking,predicate=commands:holding/menu] run scoreboard players set @s textClick 64