...
execute at @e[type=arrow,nbt={item:{components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:poison",amplifier:1b,duration:100,show_particles:0b}]}}}}] run particle dust{color:[0.631,0.000,1.000],scale:1} ~ ~ ~ 0 0 0 1 0 force

execute at @e[type=arrow,nbt={item:{components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:luck",amplifier:1b,duration:1,show_particles:0b}]}}}}] run particle dust{color:[0.047,0.361,0.000],scale:1} ~ ~ ~ 0 0 0 1 0 force

execute at @e[type=arrow,nbt={item:{components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:luck",amplifier:1b,duration:2,show_particles:0b}]}}}}] run particle dust{color:[0.000,1.000,1.000],scale:1} ~ ~ ~ 0 0 0 1 0 force

execute at @e[type=arrow,nbt={item:{components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:luck",amplifier:1b,duration:3,show_particles:0b}]}}}}] run particle dust{color:[0.749,0.702,0.000],scale:1} ~ ~ ~ 0 0 0 1 0 force

execute at @e[type=arrow,nbt={item:{components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:luck",amplifier:1b,duration:4,show_particles:0b}]}}}}] run particle dust{color:[1.000,0.110,0.110],scale:1} ~ ~ ~ 0 0 0 1 0 force
