...
execute if score #mysteryfood RNG matches 1..6 if entity @s[team=Red] as @a[distance=..10,team=Red] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[tag=basketuser]"}
...
execute if score #mysteryfood RNG matches 1..6 if entity @s[team=Blue] as @a[distance=..10,team=Blue] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[tag=basketuser]"}
