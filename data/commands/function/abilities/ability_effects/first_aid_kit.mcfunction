execute if entity @s[team=Red] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[team=Red,scores={Kit=16}]"}

execute if entity @s[team=Blue] run function commands:utils/heal/custom_heal {health:4,ult_charge_receiver:"@a[team=Blue,scores={Kit=16}]"}
