...
execute if entity @s[tag=!upgraded] if score #gunbladeammo counter matches ..14 run function commands:abilities/ability_effects/gunblade_reload

execute if entity @s[tag=upgraded] if score #gunbladeammo counter matches ..19 run function commands:abilities/ability_effects/gunblade_reload
