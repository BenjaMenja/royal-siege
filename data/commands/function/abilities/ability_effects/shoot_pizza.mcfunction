...
execute if entity @s[tag=ovenred] if entity @a[tag=inLOS,team=Blue] at @s anchored eyes run summon minecraft:fireball ^ ^ ^ {ExplosionPower:4b,Tags:["pizzared","pizza","redProj"],Item:{id:"minecraft:pumpkin_pie",count:1,components:{"minecraft:item_model":"royalsiege:pizza"}}}

execute if entity @s[tag=ovenblue] if entity @a[tag=inLOS,team=Red] at @s anchored eyes run summon minecraft:fireball ^ ^ ^ {ExplosionPower:4b,Tags:["pizzablue","pizza","blueProj"],Item:{id:"minecraft:pumpkin_pie",count:1,components:{"minecraft:item_model":"royalsiege:pizza"}}}
