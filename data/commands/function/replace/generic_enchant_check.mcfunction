...
$data merge storage royalsiege:temporary_storage {enchant_modifier:"commands:$(enchant_modifier)"}
...
$execute if data storage royalsiege:temporary_storage {activeHotbarSuccess:0} if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":$(custom_data)}}}} run function commands:replace/generic_enchant_offhand {enchant_modifier:$(enchant_modifier)}
...
execute if data storage royalsiege:temporary_storage {activeHotbarSuccess:1} run function commands:replace/generic_enchant with storage royalsiege:temporary_storage