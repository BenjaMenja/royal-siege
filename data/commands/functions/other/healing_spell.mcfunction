execute at @s[team=Red] run effect give @a[team=Red,distance=..10] regeneration 6 1 true

execute at @s[team=Red] run effect give @a[team=Red,distance=..10] instant_health 1 0 true
...
execute at @s[team=Blue] run effect give @a[team=Blue,distance=..10] regeneration 6 1 true

execute at @s[team=Blue] run effect give @a[team=Blue,distance=..10] instant_health 1 0 true
