execute if entity @s[tag=redmushroom] run summon area_effect_cloud ~ ~ ~ {Particle:"block brown_mushroom_block",ReapplicationDelay:10,Radius:4f,RadiusPerTick:0f,RadiusOnUse:0.3f,Duration:160,Effects:[{Id:19b,Amplifier:1b,Duration:20,ShowParticles:0b}],Tags:["redmushroom","mushroom"]}
...
execute if entity @s[tag=bluemushroom] run summon area_effect_cloud ~ ~ ~ {Particle:"block brown_mushroom_block",ReapplicationDelay:10,Radius:4f,RadiusPerTick:0f,RadiusOnUse:0.3f,Duration:160,Effects:[{Id:19b,Amplifier:1b,Duration:20,ShowParticles:0b}],Tags:["bluemushroom","mushroom"]}
