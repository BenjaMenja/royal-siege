execute at @s[team=Red] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["hookRed","hook"],Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:29}}}

execute at @s[team=Blue] anchored eyes run summon item ^ ^ ^1 {Health:1000,PickupDelay:32767,NoGravity:1b,Tags:["hookBlue","hook"],Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:29}}}
