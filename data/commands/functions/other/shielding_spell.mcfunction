...
execute if entity @s[team=Red] run effect give @a[team=Red,tag=blessed] absorption 8 2 true
...
execute if entity @s[team=Blue] run effect give @a[team=Blue,tag=blessed] absorption 8 2 true
