...
execute if entity @s[tag=redTether] run clear @a[team=Red,tag=tethered] carrot_on_a_stick{safetytether:1b}

execute if entity @s[tag=blueTether] run clear @a[team=Blue,tag=tethered] carrot_on_a_stick{safetytether:1b}
