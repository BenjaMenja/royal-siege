...
execute if entity @s[team=Blue] run data modify entity @e[type=arrow,tag=coinArrow,tag=!stop,limit=1] Owner set from entity @a[scores={Kit=13},team=Red,limit=1] UUID
