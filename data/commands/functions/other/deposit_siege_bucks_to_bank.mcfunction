...
execute if score @s textClick matches 186 at @s run playsound minecraft:entity.experience_orb.pickup master @s ~ ~ ~ 1 2
...
$execute if score @s textClick matches 182..185 if score @s Money matches $(siege_bucks).. at @s run playsound minecraft:entity.experience_orb.pickup master @s ~ ~ ~ 1 2
