...
$execute if score @s[team=Blue] textClick matches 187..190 if score #blue siegeBank matches $(siege_bucks).. run scoreboard players remove #red siegeBank $(siege_bucks)
