summon minecraft:item_frame ~ ~ ~ {Tags:["oven"],Invulnerable:1b,Invisible:1b,Fixed:1b,Facing:3b,Item:{id:"minecraft:stone_bricks",Count:1b,components:{"minecraft:custom_model_data":134}}}
