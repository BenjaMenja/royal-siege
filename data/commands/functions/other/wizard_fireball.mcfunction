...
scoreboard players operation @e[type=fireball,tag=WF,limit=1,tag=!stop] posX -= @a[scores={Kit=6,FireballTimer=80..},tag=wizard] posX

scoreboard players operation @e[type=fireball,tag=WF,limit=1,tag=!stop] posY -= @a[scores={Kit=6,FireballTimer=80..},tag=wizard] posY

scoreboard players operation @e[type=fireball,tag=WF,limit=1,tag=!stop] posZ -= @a[scores={Kit=6,FireballTimer=80..},tag=wizard] posZ

execute as @a[scores={Kit=6,FireballTimer=120..}] run execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] direction[0] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posX

execute as @a[scores={Kit=6,FireballTimer=120..}] run execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] direction[1] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posY

execute as @a[scores={Kit=6,FireballTimer=120..}] run execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] direction[2] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posZ

execute as @a[scores={Kit=6,FireballTimer=120..}] run execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] power[0] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posX

execute as @a[scores={Kit=6,FireballTimer=120..}] run execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] power[1] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posY

execute as @a[scores={Kit=6,FireballTimer=120..}] run execute store result entity @e[type=fireball,tag=WF,limit=1,tag=!stop] power[2] double 0.0008 run scoreboard players get @e[type=fireball,tag=WF,limit=1,tag=!stop] posZ
