...
execute if score #cardsChecked cardTemp matches 7 run tellraw @a[tag=cardShooter] [{"text":"Hand: ","color":"aqua"},{"score":{"name":"@e[type=item,tag=pCard,tag=card1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card1]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card2]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card2]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card3]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card3]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card4]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card4]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card5]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card5]"},{"text":" | "},{"score":{"name":"@e[type=item,tag=pCard,tag=card6]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card6]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card7]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card7]"}]
