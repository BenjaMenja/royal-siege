...
execute as @e[type=item,nbt={Item:{tag:{cardsuite:1b}}}] store result score #rng RNG run data get entity @s Item.tag.AttributeModifiers.[{}].Amount
scoreboard players operation @s cardSuite = #rng RNG
kill @e[type=item,nbt={Item:{tag:{cardsuite:1b}}}]
...
execute if score #cardsChecked cardTemp matches 7 run tellraw @a[tag=cardShooter] [{"text":"Hand: ","color":"aqua"},{"score":{"name":"@e[type=item,tag=pCard,tag=card1,limit=1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card1]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card2,limit=1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card2]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card3,limit=1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card3]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card4,limit=1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card4]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card5,limit=1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card5]"},{"text":" | "},{"score":{"name":"@e[type=item,tag=pCard,tag=card6,limit=1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card6]"},{"text":" "},{"score":{"name":"@e[type=item,tag=pCard,tag=card7,limit=1]","objective":"cardValue"},"color":"green"},{"selector":"@e[type=item,tag=pCard,tag=card7]"}]
