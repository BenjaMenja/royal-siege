...
execute if entity @s[team=Red] at @a[team=Red,distance=..10] run particle dust{color:[1.000,0.000,0.000],scale:1} ~ ~ ~ 0 0 0 1 10 normal
...
execute if entity @s[team=Blue] at @a[team=Blue,distance=..10] run particle dust{color:[0.000,0.000,1.000],scale:1} ~ ~ ~ 0 0 0 1 10 normal
