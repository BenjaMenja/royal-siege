...
execute as @e[tag=bluecavalry] at @s run summon horse ~ ~1 ~ {Team:"Blue",Health:75f,Tame:1b,Variant:770,Tags:["BlueHorse"],ActiveEffects:[{Id:12,Amplifier:0b,Duration:1000000,ShowParticles:0b}],Attributes:[{Name:"generic.max_health",Base:75},{Name:"generic.knockback_resistance",Base:1},{Name:"generic.movement_speed",Base:-1.0},{Name:"horse.jump_strength",Base:1.2}],SaddleItem:{id:"minecraft:saddle",Count:1b},ArmorItem:{id:"minecraft:diamond_horse_armor",Count:1b}}
