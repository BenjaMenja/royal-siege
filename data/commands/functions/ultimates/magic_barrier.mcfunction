execute at @s run particle dust{color:[0.933,1.000,0.000],scale:1} ~ ~1 ~-0.5 0.5 0.7 0 0 5 force @a[tag=!protected]

execute at @s run particle dust{color:[0.933,1.000,0.000],scale:1} ~-0.5 ~1 ~ 0.5 0.7 0 0 5 force @a[tag=!protected]
