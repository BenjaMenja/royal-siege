...
execute as @e[type=item,nbt={Item:{tag:{ai_death:1b}}}] store result score #rng RNG run data get entity @s Item.tag.AttributeModifiers.[{}].Amount
kill @e[type=item,nbt={Item:{tag:{ai_death:1b}}}]
