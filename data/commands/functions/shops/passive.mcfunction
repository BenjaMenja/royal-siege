...
execute as @a[scores={Money=2000..},tag=!upgraded] unless score @s Kit matches 7 unless score @s Kit matches 12 run function commands:shops/passive2

execute as @a[scores={Money=3000..},tag=!upgraded] if score @s Kit matches 7 run function commands:shops/passive2

execute as @a[scores={Money=1500..},tag=!upgraded] if score @s Kit matches 12 run function commands:shops/passive2