...
execute if score #warriortemp classInfo matches 1 if entity @a[tag=End,scores={Kit=1}] run scoreboard players add #warriorwins classInfo 1

execute if score #ninjatemp classInfo matches 1 if entity @a[tag=End,scores={Kit=2}] run scoreboard players add #ninjawins classInfo 1

execute if score #guardiantemp classInfo matches 1 if entity @a[tag=End,scores={Kit=3}] run scoreboard players add #guardianwins classInfo 1

execute if score #angeltemp classInfo matches 1 if entity @a[tag=End,scores={Kit=4}] run scoreboard players add #angelwins classInfo 1

execute if score #archertemp classInfo matches 1 if entity @a[tag=End,scores={Kit=5}] run scoreboard players add #archerwins classInfo 1

execute if score #wizardtemp classInfo matches 1 if entity @a[tag=End,scores={Kit=6}] run scoreboard players add #wizardwins classInfo 1

execute if score #piratetemp classInfo matches 1 if entity @a[tag=End,scores={Kit=7}] run scoreboard players add #piratewins classInfo 1

execute if score #enttemp classInfo matches 1 if entity @a[tag=End,scores={Kit=8}] run scoreboard players add #entwins classInfo 1

execute if score #poseidontemp classInfo matches 1 if entity @a[tag=End,scores={Kit=9}] run scoreboard players add #poseidonwins classInfo 1

execute if score #robottemp classInfo matches 1 if entity @a[tag=End,scores={Kit=10}] run scoreboard players add #robotwins classInfo 1

execute if score #cheftemp classInfo matches 1 if entity @a[tag=End,scores={Kit=11}] run scoreboard players add #chefwins classInfo 1

execute if score #dragontemp classInfo matches 1 if entity @a[tag=End,scores={Kit=12}] run scoreboard players add #dragonwins classInfo 1
...
execute if score #ninjatemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=2}] run scoreboard players add #ninjalosses classInfo 1

execute if score #guardiantemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=3}] run scoreboard players add #guardianlosses classInfo 1

execute if score #angeltemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=4}] run scoreboard players add #angellosses classInfo 1

execute if score #archertemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=5}] run scoreboard players add #archerlosses classInfo 1

execute if score #wizardtemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=6}] run scoreboard players add #wizardlosses classInfo 1

execute if score #piratetemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=7}] run scoreboard players add #piratelosses classInfo 1

execute if score #enttemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=8}] run scoreboard players add #entlosses classInfo 1

execute if score #poseidontemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=9}] run scoreboard players add #poseidonlosses classInfo 1

execute if score #robottemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=10}] run scoreboard players add #robotlosses classInfo 1

execute if score #cheftemp classInfo matches 1 unless entity @a[tag=End,scores={Kit=11}] run scoreboard players add #cheflosses classInfo 1
