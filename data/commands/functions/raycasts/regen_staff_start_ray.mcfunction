...
scoreboard players set @a[tag=regen] RegenTimer 0
execute if score #distance ray.regen matches 200.. run scoreboard players set @s RegenTimer 80
function commands:replace/regen_staff_replace
