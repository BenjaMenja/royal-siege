...
execute if block ~ ~ ~ #commands:can_place_on_without_grass run scoreboard players set #distance ray.lightning 100
particle dust{color:[0.000,1.000,1.000],scale:1} ~ ~ ~ 0 0 0 1 5 normal
