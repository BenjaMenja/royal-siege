summon snowball ~ ~ ~ {Tags:["toxinballred","init","snowball","redProj"],Passengers:[{id:"minecraft:area_effect_cloud",Age:-2147483648,Duration:-1,WaitTime:-2147483648,Tags:["toxinitemred","redProj"]}],Item:{id:"minecraft:snowball",Count:1b,components:{"minecraft:custom_model_data":107}}}
