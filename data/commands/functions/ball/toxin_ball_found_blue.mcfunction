summon snowball ~ ~ ~ {Tags:["toxinballblue","init","snowball"],Passengers:[{id:"minecraft:area_effect_cloud",Duration:-1,Age:-2147483648,WaitTime:-2147483648,Tags:["toxinitemblue"]}],Item:{id:"minecraft:snowball",Count:1b,tag:{CustomModelData:107}}}
