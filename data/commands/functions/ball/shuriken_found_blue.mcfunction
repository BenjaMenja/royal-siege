summon snowball ~ ~ ~ {Tags:["shurikenblue","init","snowball","blueProj"],Passengers:[{id:"minecraft:area_effect_cloud",Duration:-1,Age:-2147483648,WaitTime:-2147483648,Tags:["shurikenblue","blueProj"]}],Item:{id:"minecraft:snowball",Count:1b,components:{"minecraft:custom_model_data":95}}}
