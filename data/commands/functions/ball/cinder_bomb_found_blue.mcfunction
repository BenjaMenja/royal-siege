summon snowball ~ ~ ~ {Tags:["cinderbombblue","init","snowball"],Passengers:[{id:"minecraft:area_effect_cloud",Duration:-1,Age:-2147483648,WaitTime:-2147483648,Tags:["cinderbombblue"]}],Item:{id:"minecraft:snowball",Count:1b,tag:{CustomModelData:192}}}
